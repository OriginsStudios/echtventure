    ...
    <section className="py-24 bg-white bg-five-lines container-padding">
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={approachRef} className="max-w-4xl mx-auto text-center mb-16">
          <p className="font-butler text-[24px] text-gray-700 leading-[1.6em] mb-8">
          ...
          <div className="bg-backgroundColorWhite border border-lineColor p-8 rounded-lg">
            <h3 className="font-butler text-[28px] font-semibold text-black mb-4">
              Our Philosophy
            </h3>
            <p className="font-butler text-[20px] text-gray-700 leading-[1.5em]">
        ...
        >
          ...
          <div className="method-card bg-white border border-lineColor p-8 rounded-lg hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="font-butler text-[24px] font-semibold text-black mb-4 text-center">
              Corporate Management Experience
            </h3>
            <p className="font-butler text-[18px] text-gray-700 leading-[1.5em] text-center">
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-12 h-12 bg-[#6a3a3a] text-white rounded-full flex items-center justify-center mx-auto mb-4 font-butler font-bold text-xl">
                1
              </div>
              <h4 className="font-butler text-[20px] font-semibold text-black mb-2">
                <span className="italic font-light">Awareness</span>
              </h4>
              <p className="font-butler text-[16px] text-gray-700">
