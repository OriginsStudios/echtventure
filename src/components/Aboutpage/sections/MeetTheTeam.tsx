      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div ref={profileRef} className="relative">
            <div className="relative max-w-md mx-auto">
              ...
              <div className="absolute -top-4 -right-4 bg-white p-4 rounded-lg shadow-md border border-lineColor">
                <p className="font-butler text-[14px] font-semibold text-[#6a3a3a]">
                  Certified Professional Coach
                </p>
              </div>
              <div className="absolute -bottom-4 -left-4 bg-[#6a3a3a] text-white p-4 rounded-lg shadow-md">
                <p className="font-butler text-[14px] font-semibold">
          ...
          <div ref={contentRef} className="space-y-6">
            <div>
              <h3 className="font-butler text-[36px] font-semibold text-black mb-2">
                Keith Tay
              </h3>
              <p className="font-butler text-[20px] text-[#6a3a3a] font-semibold mb-4">
                Founder & Chief Coach
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="font-butler text-[18px] text-gray-700 leading-[1.6em]">
            ...
            <div className="bg-white p-6 rounded-lg border border-lineColor">
              <h4 className="font-butler text-[24px] font-semibold text-black mb-4">
                Key Achievements
              </h4>
              <ul className="space-y-2">
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-[#6a3a3a] rounded-full mt-3 mr-3 flex-shrink-0"></span>
                  <span className="font-butler text-[16px] text-gray-700">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/coaches/keith-tay">
                <button className="bg-[#6a3a3a] text-white font-butler text-[16px] font-bold py-3 px-8 rounded-full hover:bg-[#7a4a4a] transition-colors duration-300">
                  Read Keith's Full Profile
                </button>
              </Link>
              <Link href="/coaches">
                <button className="border border-[#6a3a3a] text-[#6a3a3a] font-butler text-[16px] font-bold py-3 px-8 rounded-full hover:bg-[#6a3a3a] hover:text-white transition-colors duration-300">
                  Meet Our Team
                </button>
              </Link>
            </div>
        ...
        <div className="mt-20 text-center">
          <AnimatedTitle>
            <h3 className="font-butler text-[32px] font-normal text-black mb-8">
              Our Extended Network
            </h3>
          </AnimatedTitle>

          <p className="font-butler text-[20px] text-gray-700 leading-[1.6em] max-w-3xl mx-auto mb-8">
          ...
          <Link href="/coaches">
            <button className="bg-backgroundColorWhite border border-[#6a3a3a] text-[#6a3a3a] font-butler text-[16px] font-bold py-3 px-8 rounded-full hover:bg-[#6a3a3a] hover:text-white transition-colors duration-300">
