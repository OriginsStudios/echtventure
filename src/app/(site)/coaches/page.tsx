...
export default function CoachesPage() {
  ...
  return (
    <main className="min-h-screen px-6 md:px-10 lg:px-16 py-14 bg-five-lines">
      <section className="max-w-6xl mx-auto bg-five-lines">
      ...
      {/* Enneagram Test Section */}
      <section
        ref={enneagramRef}
        className="py-20 bg-slate-900 bg-five-lines-blackbg text-white mt-20 relative"
      >
        {/* Subtle Background Pattern */}
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-10 right-10 w-96 h-96 border border-slate-700 rounded-full"></div>
